...
const Jobs = () => {
    return (
        <div className="flex flex-col gap-6 w-full m-auto px-4">
                <h2 className="bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10  font-bold tracking-tight">
                    Jobs at Ableton
                </h2>
